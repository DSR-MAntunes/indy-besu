...
class _UniffiRustBuffer(ctypes.Structure):
    ...
    @staticmethod
    def alloc(size):
        return _uniffi_rust_call(_UniffiLib.ffi_indy_besu_vdr_uniffi_rustbuffer_alloc, size)

    @staticmethod
    def reserve(rbuf, additional):
        return _uniffi_rust_call(_UniffiLib.ffi_indy_besu_vdr_uniffi_rustbuffer_reserve, rbuf, additional)

    def free(self):
        return _uniffi_rust_call(_UniffiLib.ffi_indy_besu_vdr_uniffi_rustbuffer_free, self)
...
def _uniffi_check_api_checksums(lib):
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_add_validator_transaction() != 17544:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_assign_role_transaction() != 48455:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_create_credential_definition_endorsing_data() != 28006:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_create_credential_definition_transaction() != 2416:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_create_did_endorsing_data() != 57302:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_create_did_mapping_endorsing_data() != 61925:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_create_did_mapping_transaction() != 13401:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_create_did_transaction() != 26588:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_create_resource_mapping_endorsing_data() != 15792:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_create_resource_mapping_transaction() != 20591:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_create_revocation_registry_definition_endorsing_data() != 30971:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_create_revocation_registry_definition_transaction() != 18392:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_create_revocation_registry_entry_endorsing_data() != 24904:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_create_revocation_registry_entry_transaction() != 19425:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_create_schema_endorsing_data() != 40040:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_create_schema_transaction() != 31844:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_deactivate_did_endorsing_data() != 608:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_deactivate_did_transaction() != 45652:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_did_add_delegate_endorsing_data() != 17076:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_did_add_delegate_transaction() != 53852:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_did_change_owner_endorsing_data() != 62197:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_did_change_owner_transaction() != 3608:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_did_revoke_attribute_endorsing_data() != 34851:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_did_revoke_attribute_transaction() != 59989:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_did_revoke_delegate_endorsing_data() != 49207:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_did_revoke_delegate_transaction() != 2328:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_did_set_attribute_endorsing_data() != 7397:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_did_set_attribute_transaction() != 13973:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_endorsement_transaction() != 34440:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_get_did_changed_transaction() != 8267:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_get_did_events_query() != 317:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_get_did_mapping_transaction() != 39080:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_get_did_owner_transaction() != 12652:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_get_identity_nonce_transaction() != 64086:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_get_resource_mapping_transaction() != 15581:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_get_role_transaction() != 1974:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_get_validators_transaction() != 3031:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_has_role_transaction() != 64620:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_remove_validator_transaction() != 24903:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_resolve_credential_definition_transaction() != 53817:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_resolve_did_transaction() != 64265:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_resolve_revocation_registry_definition_transaction() != 31863:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_resolve_schema_transaction() != 8247:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_revoke_role_transaction() != 11236:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_update_did_endorsing_data() != 11014:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_update_did_transaction() != 13890:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_credential_definition_from_string() != 22632:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_credential_definition_get_id() != 36149:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_credential_definition_to_string() != 43253:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_parse_did_attribute_changed_event_response() != 50272:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_parse_did_changed_result() != 21318:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_parse_did_delegate_changed_event_response() != 7139:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_parse_did_event_response() != 29348:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_parse_did_mapping_result() != 50062:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_parse_did_nonce_result() != 3708:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_parse_did_owner_changed_event_response() != 58135:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_parse_did_owner_result() != 40779:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_parse_get_role_result() != 48667:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_parse_get_validators_result() != 18884:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_parse_has_role_result() != 13660:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_parse_resolve_credential_definition_result() != 59840:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_parse_resolve_did_result() != 38472:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_parse_resolve_schema_result() != 56824:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_parse_resource_mapping_result() != 52934:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_parse_revocation_registry_definition() != 47853:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_resolve_credential_definition() != 20565:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_resolve_did() != 25433:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_resolve_revocation_registry_definition() != 54261:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_resolve_revocation_registry_status_list() != 47910:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_resolve_revocation_registry_status_list_full() != 35598:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_resolve_schema() != 41551:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_revocation_registry_definition_from_string() != 15188:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_revocation_registry_definition_get_id() != 32388:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_revocation_registry_definition_to_string() != 52032:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_revocation_registry_entry_from_string() != 21449:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_revocation_registry_entry_to_string() != 9445:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_revocation_status_list_from_string() != 8913:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_revocation_status_list_to_string() != 27236:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_schema_from_string() != 45767:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_schema_get_id() != 53948:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_schema_to_string() != 53177:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_transaction_create() != 4351:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_transaction_endorsing_data_create() != 2241:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_transaction_endorsing_data_from_string() != 46876:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_transaction_endorsing_data_get_signing_bytes() != 57248:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_transaction_endorsing_data_to_string() != 1810:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_transaction_from_string() != 24094:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_transaction_get_signing_bytes() != 11747:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_transaction_to_string() != 35558:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_method_ledgerclient_ping.restype = ctypes.c_uint64
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_method_ledgerclient_query_events.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_method_ledgerclient_query_events.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_add_validator_transaction.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_assign_role_transaction.restype = ctypes.c_uint64
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_create_credential_definition_endorsing_data.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_create_credential_definition_endorsing_data.restype = ctypes.c_uint64
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_create_credential_definition_transaction.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_create_credential_definition_transaction.restype = ctypes.c_uint64
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_create_did_endorsing_data.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_create_did_endorsing_data.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_create_did_mapping_endorsing_data.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_create_did_mapping_transaction.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_create_did_transaction.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_create_resource_mapping_endorsing_data.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_create_resource_mapping_transaction.restype = ctypes.c_uint64
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_create_revocation_registry_definition_endorsing_data.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_create_revocation_registry_definition_endorsing_data.restype = ctypes.c_uint64
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_create_revocation_registry_definition_transaction.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_create_revocation_registry_definition_transaction.restype = ctypes.c_uint64
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_create_revocation_registry_entry_endorsing_data.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_create_revocation_registry_entry_endorsing_data.restype = ctypes.c_uint64
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_create_revocation_registry_entry_transaction.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_create_revocation_registry_entry_transaction.restype = ctypes.c_uint64
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_create_schema_endorsing_data.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_create_schema_endorsing_data.restype = ctypes.c_uint64
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_create_schema_transaction.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_create_schema_transaction.restype = ctypes.c_uint64
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_deactivate_did_endorsing_data.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_deactivate_did_endorsing_data.restype = ctypes.c_uint64
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_deactivate_did_transaction.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_deactivate_did_transaction.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_did_add_delegate_endorsing_data.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_did_add_delegate_transaction.restype = ctypes.c_uint64
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_did_change_owner_endorsing_data.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_did_change_owner_endorsing_data.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_did_change_owner_transaction.restype = ctypes.c_uint64
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_did_revoke_attribute_endorsing_data.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_did_revoke_attribute_endorsing_data.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_did_revoke_attribute_transaction.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_did_revoke_delegate_endorsing_data.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_did_revoke_delegate_transaction.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_did_set_attribute_endorsing_data.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_did_set_attribute_transaction.restype = ctypes.c_uint64
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_endorsement_transaction.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_endorsement_transaction.restype = ctypes.c_uint64
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_get_did_changed_transaction.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_get_did_changed_transaction.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_get_did_events_query.restype = ctypes.c_uint64
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_get_did_mapping_transaction.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_get_did_mapping_transaction.restype = ctypes.c_uint64
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_get_did_owner_transaction.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_get_did_owner_transaction.restype = ctypes.c_uint64
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_get_identity_nonce_transaction.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_get_identity_nonce_transaction.restype = ctypes.c_uint64
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_get_resource_mapping_transaction.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_get_resource_mapping_transaction.restype = ctypes.c_uint64
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_get_role_transaction.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_get_role_transaction.restype = ctypes.c_uint64
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_get_validators_transaction.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_get_validators_transaction.restype = ctypes.c_uint64
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_has_role_transaction.argtypes = (
    ctypes.c_void_p,
    ctypes.c_uint8,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_has_role_transaction.restype = ctypes.c_uint64
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_remove_validator_transaction.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_remove_validator_transaction.restype = ctypes.c_uint64
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_resolve_credential_definition_transaction.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_resolve_credential_definition_transaction.restype = ctypes.c_uint64
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_resolve_did_transaction.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_resolve_did_transaction.restype = ctypes.c_uint64
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_resolve_revocation_registry_definition_transaction.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_resolve_revocation_registry_definition_transaction.restype = ctypes.c_uint64
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_resolve_schema_transaction.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_resolve_schema_transaction.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_revoke_role_transaction.restype = ctypes.c_uint64
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_update_did_endorsing_data.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_update_did_endorsing_data.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_update_did_transaction.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_parse_revocation_registry_definition.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_parse_revocation_registry_definition.restype = _UniffiRustBuffer
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_resolve_credential_definition.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_resolve_credential_definition.restype = ctypes.c_uint64
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_resolve_did.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_resolve_did.restype = ctypes.c_uint64
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_resolve_revocation_registry_definition.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_resolve_revocation_registry_definition.restype = ctypes.c_uint64
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_resolve_revocation_registry_status_list.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    ctypes.c_uint64,
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_resolve_revocation_registry_status_list.restype = ctypes.c_uint64
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_resolve_revocation_registry_status_list_full.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    ctypes.c_uint64,
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_resolve_revocation_registry_status_list_full.restype = ctypes.c_uint64
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_resolve_schema.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_resolve_schema.restype = ctypes.c_uint64
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_revocation_registry_definition_from_string.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_revocation_registry_definition_from_string.restype = _UniffiRustBuffer
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_revocation_registry_definition_get_id.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_revocation_registry_definition_get_id.restype = _UniffiRustBuffer
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_revocation_registry_definition_to_string.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_revocation_registry_definition_to_string.restype = _UniffiRustBuffer
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_revocation_registry_entry_from_string.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_revocation_registry_entry_from_string.restype = _UniffiRustBuffer
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_revocation_registry_entry_to_string.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_revocation_registry_entry_to_string.restype = _UniffiRustBuffer
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_revocation_status_list_from_string.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_revocation_status_list_from_string.restype = _UniffiRustBuffer
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_revocation_status_list_to_string.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_revocation_status_list_to_string.restype = _UniffiRustBuffer
...
_UniffiLib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_create_revocation_registry_definition_endorsing_data.argtypes = (
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_create_revocation_registry_definition_endorsing_data.restype = ctypes.c_uint16
_UniffiLib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_create_revocation_registry_definition_transaction.argtypes = (
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_create_revocation_registry_definition_transaction.restype = ctypes.c_uint16
_UniffiLib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_create_revocation_registry_entry_endorsing_data.argtypes = (
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_create_revocation_registry_entry_endorsing_data.restype = ctypes.c_uint16
_UniffiLib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_create_revocation_registry_entry_transaction.argtypes = (
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_create_revocation_registry_entry_transaction.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_resolve_revocation_registry_definition_transaction.argtypes = (
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_resolve_revocation_registry_definition_transaction.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_indy_besu_vdr_uniffi_checksum_func_parse_revocation_registry_definition.argtypes = (
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_checksum_func_parse_revocation_registry_definition.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_indy_besu_vdr_uniffi_checksum_func_resolve_revocation_registry_definition.argtypes = (
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_checksum_func_resolve_revocation_registry_definition.restype = ctypes.c_uint16
_UniffiLib.uniffi_indy_besu_vdr_uniffi_checksum_func_resolve_revocation_registry_status_list.argtypes = (
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_checksum_func_resolve_revocation_registry_status_list.restype = ctypes.c_uint16
_UniffiLib.uniffi_indy_besu_vdr_uniffi_checksum_func_resolve_revocation_registry_status_list_full.argtypes = (
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_checksum_func_resolve_revocation_registry_status_list_full.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_indy_besu_vdr_uniffi_checksum_func_revocation_registry_definition_from_string.argtypes = (
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_checksum_func_revocation_registry_definition_from_string.restype = ctypes.c_uint16
_UniffiLib.uniffi_indy_besu_vdr_uniffi_checksum_func_revocation_registry_definition_get_id.argtypes = (
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_checksum_func_revocation_registry_definition_get_id.restype = ctypes.c_uint16
_UniffiLib.uniffi_indy_besu_vdr_uniffi_checksum_func_revocation_registry_definition_to_string.argtypes = (
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_checksum_func_revocation_registry_definition_to_string.restype = ctypes.c_uint16
_UniffiLib.uniffi_indy_besu_vdr_uniffi_checksum_func_revocation_registry_entry_from_string.argtypes = (
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_checksum_func_revocation_registry_entry_from_string.restype = ctypes.c_uint16
_UniffiLib.uniffi_indy_besu_vdr_uniffi_checksum_func_revocation_registry_entry_to_string.argtypes = (
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_checksum_func_revocation_registry_entry_to_string.restype = ctypes.c_uint16
_UniffiLib.uniffi_indy_besu_vdr_uniffi_checksum_func_revocation_status_list_from_string.argtypes = (
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_checksum_func_revocation_status_list_from_string.restype = ctypes.c_uint16
_UniffiLib.uniffi_indy_besu_vdr_uniffi_checksum_func_revocation_status_list_to_string.argtypes = (
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_checksum_func_revocation_status_list_to_string.restype = ctypes.c_uint16
...
class RevocationRegistryDefinition:
    ...
    def __str__(self):
        return "RevocationRegistryDefinition(issuer_id={}, revoc_def_type={}, cred_def_id={}, tag={}, value={})".format(self.issuer_id, self.revoc_def_type, self.cred_def_id, self.tag, self.value)

    def __eq__(self, other):
        if self.issuer_id != other.issuer_id:
            return False
        if self.revoc_def_type != other.revoc_def_type:
            return False
...
class _UniffiConverterTypeRevocationRegistryDefinition(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return RevocationRegistryDefinition(
            issuer_id=_UniffiConverterString.read(buf),
            revoc_def_type=_UniffiConverterString.read(buf),
            cred_def_id=_UniffiConverterString.read(buf),
            tag=_UniffiConverterString.read(buf),
            value=_UniffiConverterTypeJsonValue.read(buf),
        )
    ...
    def check_lower(value):
        _UniffiConverterString.check_lower(value.issuer_id)
        _UniffiConverterString.check_lower(value.revoc_def_type)
        _UniffiConverterString.check_lower(value.cred_def_id)
        _UniffiConverterString.check_lower(value.tag)
        _UniffiConverterTypeJsonValue.check_lower(value.value)
    ...
    def write(value, buf):
        _UniffiConverterString.write(value.issuer_id, buf)
        _UniffiConverterString.write(value.revoc_def_type, buf)
        _UniffiConverterString.write(value.cred_def_id, buf)
        _UniffiConverterString.write(value.tag, buf)
        _UniffiConverterTypeJsonValue.write(value.value, buf)
...
class RevocationRegistryEntry:
    ...
    def __str__(self):
        return "RevocationRegistryEntry(issuer_id={}, rev_reg_def_id={}, rev_reg_entry_data={})".format(self.issuer_id, self.rev_reg_def_id, self.rev_reg_entry_data)

    def __eq__(self, other):
        if self.issuer_id != other.issuer_id:
            return False
        if self.rev_reg_def_id != other.rev_reg_def_id:
            return False
        if self.rev_reg_entry_data != other.rev_reg_entry_data:
            return False
        return True

class _UniffiConverterTypeRevocationRegistryEntry(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return RevocationRegistryEntry(
            issuer_id=_UniffiConverterString.read(buf),
            rev_reg_def_id=_UniffiConverterString.read(buf),
            rev_reg_entry_data=_UniffiConverterTypeJsonValue.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiConverterString.check_lower(value.issuer_id)
        _UniffiConverterString.check_lower(value.rev_reg_def_id)
        _UniffiConverterTypeJsonValue.check_lower(value.rev_reg_entry_data)

    @staticmethod
    def write(value, buf):
        _UniffiConverterString.write(value.issuer_id, buf)
        _UniffiConverterString.write(value.rev_reg_def_id, buf)
        _UniffiConverterTypeJsonValue.write(value.rev_reg_entry_data, buf)
...
class RevocationStatusList:
    ...
    rev_reg_def_id: "str"
    timestamp: "int"
    revocation_list: "typing.List[int]"
    ...
    def __str__(self):
        return "RevocationStatusList(issuer_id={}, rev_reg_def_id={}, timestamp={}, revocation_list={}, current_accumulator={})".format(self.issuer_id, self.rev_reg_def_id, self.timestamp, self.revocation_list, self.current_accumulator)
    ...
    def __eq__(self, other):
        ...
        if self.timestamp != other.timestamp:
            return False
        if self.revocation_list != other.revocation_list:
            return False
        if self.current_accumulator != other.current_accumulator:
            return False
        return True

class _UniffiConverterTypeRevocationStatusList(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return RevocationStatusList(
            ...
            revocation_list=_UniffiConverterSequenceUInt32.read(buf),
            current_accumulator=_UniffiConverterString.read(buf),
        )
    ...
    def check_lower(value):
        ...
        _UniffiConverterSequenceUInt32.check_lower(value.revocation_list)
        _UniffiConverterString.check_lower(value.current_accumulator)
    ...
    def write(value, buf):
        ...
        _UniffiConverterSequenceUInt32.write(value.revocation_list, buf)
        _UniffiConverterString.write(value.current_accumulator, buf)
...
class VdrError:  # type: ignore
    ...
    class InvalidDidDocument(_UniffiTempVdrError):
        def __init__(self, msg):
            super().__init__(", ".join([
                "msg={!r}".format(msg),
            ]))
        ...
        def __repr__(self):
            return "VdrError.InvalidDidDocument({})".format(str(self))
    _UniffiTempVdrError.InvalidDidDocument = InvalidDidDocument # type: ignore
    class InvalidRevocationRegistryDefinition(_UniffiTempVdrError):
        def __init__(self, msg):
            super().__init__(", ".join([
                "msg={!r}".format(msg),
            ]))
        ...
        def __repr__(self):
            return "VdrError.InvalidRevocationRegistryDefinition({})".format(str(self))
    _UniffiTempVdrError.InvalidRevocationRegistryDefinition = InvalidRevocationRegistryDefinition # type: ignore
    class InvalidRevocationRegistryEntry(_UniffiTempVdrError):
        def __init__(self, msg):
            super().__init__(", ".join([
                "msg={!r}".format(msg),
            ]))
        ...
        def __repr__(self):
            return "VdrError.InvalidRevocationRegistryEntry({})".format(str(self))
    _UniffiTempVdrError.InvalidRevocationRegistryEntry = InvalidRevocationRegistryEntry # type: ignore
    class InvalidRevocationRegistryStatusList(_UniffiTempVdrError):
        def __init__(self, msg):
            super().__init__(", ".join([
                "msg={!r}".format(msg),
            ]))
...
class _UniffiConverterTypeVdrError(_UniffiConverterRustBuffer):
    ...
    def read(buf):
        ...
        if variant == 21:
            return VdrError.InvalidDidDocument(
                _UniffiConverterString.read(buf),
            )
        if variant == 22:
            return VdrError.InvalidRevocationRegistryDefinition(
                _UniffiConverterString.read(buf),
            )
        if variant == 23:
            return VdrError.InvalidRevocationRegistryEntry(
                _UniffiConverterString.read(buf),
            )
        if variant == 24:
    ...
    def check_lower(value):
        ...
        if isinstance(value, VdrError.InvalidCredentialDefinition):
            _UniffiConverterString.check_lower(value.msg)
            return
        if isinstance(value, VdrError.InvalidDidDocument):
            _UniffiConverterString.check_lower(value.msg)
            return
        if isinstance(value, VdrError.InvalidRevocationRegistryDefinition):
            _UniffiConverterString.check_lower(value.msg)
            return
        if isinstance(value, VdrError.InvalidRevocationRegistryEntry):
            _UniffiConverterString.check_lower(value.msg)
            return
...
class LedgerClientProtocol(typing.Protocol):
    ...
    def submit_transaction(self, transaction: "Transaction"):
        raise NotImplementedError
# LedgerClient is a Rust-only trait - it's a wrapper around a Rust implementation.
class LedgerClient():
    ...
    def __init__(self, chain_id: "int",node_address: "str",contract_configs: "typing.List[ContractConfig]",network: "typing.Optional[str]",quorum_config: "typing.Optional[QuorumConfig]"):
        ...
        self._pointer = _uniffi_rust_call_with_error(_UniffiConverterTypeVdrError,_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_constructor_ledgerclient_new,
    ...
    def __del__(self):
        ...
        if pointer is not None:
            _uniffi_rust_call(_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_free_ledgerclient, pointer)

    def _uniffi_clone_pointer(self):
        return _uniffi_rust_call(_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_clone_ledgerclient, self._pointer)
    ...
    async def get_receipt(self, hash: "bytes") -> "str":
...
_UniffiConverterTypeVdrError,
    ...
    async def query_events(self, query: "EventQuery") -> "typing.List[EventLog]":
...
_UniffiConverterTypeVdrError,
    ...
    async def submit_transaction(self, transaction: "Transaction") -> "bytes":
...
async def build_add_validator_transaction(client: "LedgerClient",_from: "str",validator_address: "str") -> "Transaction":
...
async def build_assign_role_transaction(client: "LedgerClient",_from: "str",role: "int",account: "str") -> "Transaction":
...
async def build_create_credential_definition_endorsing_data(client: "LedgerClient",credential_definition: "CredentialDefinition") -> "TransactionEndorsingData":
...
async def build_create_credential_definition_transaction(client: "LedgerClient",_from: "str",credential_definition: "CredentialDefinition") -> "Transaction":
...
async def build_create_did_endorsing_data(client: "LedgerClient",did: "str",did_doc: "str") -> "TransactionEndorsingData":
...
async def build_create_did_mapping_endorsing_data(client: "LedgerClient",did: "str",legacy_identifier: "str",legacy_verkey: "str",ed25519_signature: "bytes") -> "TransactionEndorsingData":
...
async def build_create_did_mapping_transaction(client: "LedgerClient",_from: "str",did: "str",legacy_identifier: "str",legacy_verkey: "str",ed25519_signature: "bytes") -> "Transaction":
...
async def build_create_did_transaction(client: "LedgerClient",_from: "str",did: "str",did_doc: "JsonValue") -> "Transaction":
...
async def build_create_resource_mapping_endorsing_data(client: "LedgerClient",did: "str",legacy_issuer_identifier: "str",legacy_identifier: "str",new_identifier: "str") -> "TransactionEndorsingData":
...
async def build_create_resource_mapping_transaction(client: "LedgerClient",_from: "str",did: "str",legacy_issuer_identifier: "str",legacy_identifier: "str",new_identifier: "str") -> "Transaction":
...
async def build_create_revocation_registry_definition_endorsing_data(client: "LedgerClient",rev_reg_def: "RevocationRegistryDefinition") -> "TransactionEndorsingData":

    _UniffiConverterTypeLedgerClient.check_lower(client)
    
    _UniffiConverterTypeRevocationRegistryDefinition.check_lower(rev_reg_def)
    
    return await _uniffi_rust_call_async(
        _UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_create_revocation_registry_definition_endorsing_data(
        _UniffiConverterTypeLedgerClient.lower(client),
        _UniffiConverterTypeRevocationRegistryDefinition.lower(rev_reg_def)),
        _UniffiLib.ffi_indy_besu_vdr_uniffi_rust_future_poll_rust_buffer,
        _UniffiLib.ffi_indy_besu_vdr_uniffi_rust_future_complete_rust_buffer,
        _UniffiLib.ffi_indy_besu_vdr_uniffi_rust_future_free_rust_buffer,
        # lift function
...
async def build_create_revocation_registry_definition_transaction(client: "LedgerClient",_from: "str",rev_reg_def: "RevocationRegistryDefinition") -> "Transaction":
    ...
    return await _uniffi_rust_call_async(
        _UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_create_revocation_registry_definition_transaction(
        _UniffiConverterTypeLedgerClient.lower(client),
        _UniffiConverterString.lower(_from),
        _UniffiConverterTypeRevocationRegistryDefinition.lower(rev_reg_def)),
        _UniffiLib.ffi_indy_besu_vdr_uniffi_rust_future_poll_rust_buffer,
...
async def build_create_revocation_registry_entry_endorsing_data(client: "LedgerClient",rev_reg_entry: "RevocationRegistryEntry") -> "TransactionEndorsingData":

    _UniffiConverterTypeLedgerClient.check_lower(client)
    
    _UniffiConverterTypeRevocationRegistryEntry.check_lower(rev_reg_entry)
    
    return await _uniffi_rust_call_async(
        _UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_create_revocation_registry_entry_endorsing_data(
        _UniffiConverterTypeLedgerClient.lower(client),
        _UniffiConverterTypeRevocationRegistryEntry.lower(rev_reg_entry)),
        _UniffiLib.ffi_indy_besu_vdr_uniffi_rust_future_poll_rust_buffer,
        _UniffiLib.ffi_indy_besu_vdr_uniffi_rust_future_complete_rust_buffer,
        _UniffiLib.ffi_indy_besu_vdr_uniffi_rust_future_free_rust_buffer,
        # lift function
...
async def build_create_revocation_registry_entry_transaction(client: "LedgerClient",_from: "str",rev_reg_entry: "RevocationRegistryEntry") -> "Transaction":
    ...
    return await _uniffi_rust_call_async(
        _UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_create_revocation_registry_entry_transaction(
        _UniffiConverterTypeLedgerClient.lower(client),
        _UniffiConverterString.lower(_from),
        _UniffiConverterTypeRevocationRegistryEntry.lower(rev_reg_entry)),
        _UniffiLib.ffi_indy_besu_vdr_uniffi_rust_future_poll_rust_buffer,
...
async def build_did_add_delegate_endorsing_data(client: "LedgerClient",did: "str",delegate_type: "str",delegate: "str",validity: "int") -> "TransactionEndorsingData":
...
async def build_did_add_delegate_transaction(client: "LedgerClient",_from: "str",did: "str",delegate_type: "str",delegate: "str",validity: "int") -> "Transaction":
...
async def build_did_change_owner_endorsing_data(client: "LedgerClient",did: "str",new_owner: "str") -> "TransactionEndorsingData":
...
async def build_did_change_owner_transaction(client: "LedgerClient",_from: "str",did: "str",new_owner: "str") -> "Transaction":
...
async def build_did_revoke_attribute_endorsing_data(client: "LedgerClient",did: "str",attribute: "str") -> "TransactionEndorsingData":
...
async def build_did_revoke_attribute_transaction(client: "LedgerClient",_from: "str",did: "str",attribute: "str") -> "Transaction":
...
async def build_did_revoke_delegate_endorsing_data(client: "LedgerClient",did: "str",delegate_type: "str",delegate: "str") -> "TransactionEndorsingData":
...
async def build_did_revoke_delegate_transaction(client: "LedgerClient",_from: "str",did: "str",delegate_type: "str",delegate: "str") -> "Transaction":
...
async def build_did_set_attribute_endorsing_data(client: "LedgerClient",did: "str",attribute: "str",validity: "int") -> "TransactionEndorsingData":
...
async def build_did_set_attribute_transaction(client: "LedgerClient",_from: "str",did: "str",attribute: "str",validity: "int") -> "Transaction":
...
async def build_endorsement_transaction(client: "LedgerClient",_from: "str",endorsing_data: "TransactionEndorsingData") -> "Transaction":
...
async def build_get_did_events_query(client: "LedgerClient",did: "str",from_block: "typing.Optional[int]",to_block: "typing.Optional[int]") -> "EventQuery":
...
async def build_get_identity_nonce_transaction(client: "LedgerClient",identity: "str") -> "Transaction":
...
async def build_remove_validator_transaction(client: "LedgerClient",_from: "str",validator_address: "str") -> "Transaction":
...
async def build_resolve_revocation_registry_definition_transaction(client: "LedgerClient",rev_reg_def_id: "str") -> "Transaction":

    _UniffiConverterTypeLedgerClient.check_lower(client)
    
    _UniffiConverterString.check_lower(rev_reg_def_id)
    
    return await _uniffi_rust_call_async(
        _UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_resolve_revocation_registry_definition_transaction(
        _UniffiConverterTypeLedgerClient.lower(client),
        _UniffiConverterString.lower(rev_reg_def_id)),
        _UniffiLib.ffi_indy_besu_vdr_uniffi_rust_future_poll_rust_buffer,
        _UniffiLib.ffi_indy_besu_vdr_uniffi_rust_future_complete_rust_buffer,
        _UniffiLib.ffi_indy_besu_vdr_uniffi_rust_future_free_rust_buffer,
        # lift function
...
async def build_revoke_role_transaction(client: "LedgerClient",_from: "str",role: "int",account: "str") -> "Transaction":
...
async def build_update_did_endorsing_data(client: "LedgerClient",did: "str",did_doc: "str") -> "TransactionEndorsingData":
...
async def build_update_did_transaction(client: "LedgerClient",_from: "str",did: "str",did_doc: "str") -> "Transaction":
...
def credential_definition_from_string(string: "str") -> "CredentialDefinition":
    ...
    return _UniffiConverterTypeCredentialDefinition.lift(_uniffi_rust_call_with_error(_UniffiConverterTypeVdrError,_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_credential_definition_from_string,
...
def credential_definition_get_id(cred_def: "CredentialDefinition") -> "str":
    ...
    return _UniffiConverterString.lift(_uniffi_rust_call(_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_credential_definition_get_id,
...
def credential_definition_to_string(data: "CredentialDefinition") -> "str":
    ...
    return _UniffiConverterString.lift(_uniffi_rust_call_with_error(_UniffiConverterTypeVdrError,_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_credential_definition_to_string,
...
def parse_did_attribute_changed_event_response(client: "LedgerClient",log: "EventLog") -> "DidAttributeChanged":
    ...
    return _UniffiConverterTypeDidAttributeChanged.lift(_uniffi_rust_call_with_error(_UniffiConverterTypeVdrError,_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_parse_did_attribute_changed_event_response,
        _UniffiConverterTypeLedgerClient.lower(client),
...
def parse_did_changed_result(client: "LedgerClient",bytes: "bytes") -> "int":
    ...
    return _UniffiConverterUInt64.lift(_uniffi_rust_call_with_error(_UniffiConverterTypeVdrError,_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_parse_did_changed_result,
        _UniffiConverterTypeLedgerClient.lower(client),
...
def parse_did_delegate_changed_event_response(client: "LedgerClient",log: "EventLog") -> "DidDelegateChanged":
    ...
    return _UniffiConverterTypeDidDelegateChanged.lift(_uniffi_rust_call_with_error(_UniffiConverterTypeVdrError,_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_parse_did_delegate_changed_event_response,
        _UniffiConverterTypeLedgerClient.lower(client),
        _UniffiConverterTypeEventLog.lower(log)))
...
def parse_did_event_response(client: "LedgerClient",log: "EventLog") -> "DidEvents":
    ...
    return _UniffiConverterTypeDidEvents.lift(_uniffi_rust_call_with_error(_UniffiConverterTypeVdrError,_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_parse_did_event_response,
        _UniffiConverterTypeLedgerClient.lower(client),
        _UniffiConverterTypeEventLog.lower(log)))
...
def parse_did_mapping_result(client: "LedgerClient",bytes: "bytes") -> "str":
    ...
    return _UniffiConverterString.lift(_uniffi_rust_call_with_error(_UniffiConverterTypeVdrError,_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_parse_did_mapping_result,
        _UniffiConverterTypeLedgerClient.lower(client),
        _UniffiConverterBytes.lower(bytes)))
...
def parse_did_nonce_result(client: "LedgerClient",bytes: "bytes") -> "int":
    ...
    return _UniffiConverterUInt64.lift(_uniffi_rust_call_with_error(_UniffiConverterTypeVdrError,_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_parse_did_nonce_result,
        _UniffiConverterTypeLedgerClient.lower(client),
        _UniffiConverterBytes.lower(bytes)))
...
def parse_did_owner_changed_event_response(client: "LedgerClient",log: "EventLog") -> "DidOwnerChanged":
    ...
    return _UniffiConverterTypeDidOwnerChanged.lift(_uniffi_rust_call_with_error(_UniffiConverterTypeVdrError,_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_parse_did_owner_changed_event_response,
        _UniffiConverterTypeLedgerClient.lower(client),
        _UniffiConverterTypeEventLog.lower(log)))
...
def parse_did_owner_result(client: "LedgerClient",bytes: "bytes") -> "str":
    ...
    return _UniffiConverterString.lift(_uniffi_rust_call_with_error(_UniffiConverterTypeVdrError,_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_parse_did_owner_result,
        _UniffiConverterTypeLedgerClient.lower(client),
        _UniffiConverterBytes.lower(bytes)))
...
def parse_get_role_result(client: "LedgerClient",bytes: "bytes") -> "int":
    ...
    return _UniffiConverterUInt8.lift(_uniffi_rust_call_with_error(_UniffiConverterTypeVdrError,_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_parse_get_role_result,
        _UniffiConverterTypeLedgerClient.lower(client),
        _UniffiConverterBytes.lower(bytes)))
...
def parse_get_validators_result(client: "LedgerClient",bytes: "bytes") -> "JsonValue":
    ...
    return _UniffiConverterTypeJsonValue.lift(_uniffi_rust_call_with_error(_UniffiConverterTypeVdrError,_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_parse_get_validators_result,
        _UniffiConverterTypeLedgerClient.lower(client),
        _UniffiConverterBytes.lower(bytes)))
...
def parse_has_role_result(client: "LedgerClient",bytes: "bytes") -> "bool":
    ...
    return _UniffiConverterBool.lift(_uniffi_rust_call_with_error(_UniffiConverterTypeVdrError,_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_parse_has_role_result,
        _UniffiConverterTypeLedgerClient.lower(client),
        _UniffiConverterBytes.lower(bytes)))
...
def parse_resolve_credential_definition_result(client: "LedgerClient",bytes: "bytes") -> "JsonValue":
    ...
    return _UniffiConverterTypeJsonValue.lift(_uniffi_rust_call_with_error(_UniffiConverterTypeVdrError,_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_parse_resolve_credential_definition_result,
        _UniffiConverterTypeLedgerClient.lower(client),
        _UniffiConverterBytes.lower(bytes)))
...
def parse_resolve_did_result(client: "LedgerClient",bytes: "bytes") -> "JsonValue":
    ...
    return _UniffiConverterTypeJsonValue.lift(_uniffi_rust_call_with_error(_UniffiConverterTypeVdrError,_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_parse_resolve_did_result,
        _UniffiConverterTypeLedgerClient.lower(client),
        _UniffiConverterBytes.lower(bytes)))
...
def parse_resolve_schema_result(client: "LedgerClient",bytes: "bytes") -> "JsonValue":
    ...
    return _UniffiConverterTypeJsonValue.lift(_uniffi_rust_call_with_error(_UniffiConverterTypeVdrError,_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_parse_resolve_schema_result,
        _UniffiConverterTypeLedgerClient.lower(client),
        _UniffiConverterBytes.lower(bytes)))
...
def parse_resource_mapping_result(client: "LedgerClient",bytes: "bytes") -> "str":
    ...
    return _UniffiConverterString.lift(_uniffi_rust_call_with_error(_UniffiConverterTypeVdrError,_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_parse_resource_mapping_result,
        _UniffiConverterTypeLedgerClient.lower(client),
        _UniffiConverterBytes.lower(bytes)))


def parse_revocation_registry_definition(client: "LedgerClient",bytes: "bytes") -> "JsonValue":
    _UniffiConverterTypeLedgerClient.check_lower(client)
    
    _UniffiConverterBytes.check_lower(bytes)
    
    return _UniffiConverterTypeJsonValue.lift(_uniffi_rust_call_with_error(_UniffiConverterTypeVdrError,_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_parse_revocation_registry_definition,
        _UniffiConverterTypeLedgerClient.lower(client),
        _UniffiConverterBytes.lower(bytes)))
...
async def resolve_did(client: "LedgerClient",did: "str",options: "typing.Optional[DidResolutionOptions]") -> "JsonValue":
...
async def resolve_revocation_registry_definition(client: "LedgerClient",rev_reg_def_id: "str") -> "RevocationRegistryDefinition":
    ...
    return await _uniffi_rust_call_async(
        _UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_resolve_revocation_registry_definition(
        _UniffiConverterTypeLedgerClient.lower(client),
        _UniffiConverterString.lower(rev_reg_def_id)),
        _UniffiLib.ffi_indy_besu_vdr_uniffi_rust_future_poll_rust_buffer,
        _UniffiLib.ffi_indy_besu_vdr_uniffi_rust_future_complete_rust_buffer,
        _UniffiLib.ffi_indy_besu_vdr_uniffi_rust_future_free_rust_buffer,
        # lift function
        _UniffiConverterTypeRevocationRegistryDefinition.lift,
        
    # Error FFI converter
_UniffiConverterTypeVdrError,

    )
async def resolve_revocation_registry_status_list(client: "LedgerClient",rev_reg_def_id: "str",timestamp: "int") -> "JsonValue":

    _UniffiConverterTypeLedgerClient.check_lower(client)
    
    _UniffiConverterString.check_lower(rev_reg_def_id)
    
    _UniffiConverterUInt64.check_lower(timestamp)
    
    return await _uniffi_rust_call_async(
        _UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_resolve_revocation_registry_status_list(
        _UniffiConverterTypeLedgerClient.lower(client),
        _UniffiConverterString.lower(rev_reg_def_id),
        _UniffiConverterUInt64.lower(timestamp)),
        _UniffiLib.ffi_indy_besu_vdr_uniffi_rust_future_poll_rust_buffer,
        _UniffiLib.ffi_indy_besu_vdr_uniffi_rust_future_complete_rust_buffer,
        _UniffiLib.ffi_indy_besu_vdr_uniffi_rust_future_free_rust_buffer,
        # lift function
...
async def resolve_revocation_registry_status_list_full(client: "LedgerClient",rev_reg_def_id: "str",timestamp: "int") -> "RevocationStatusList":
    ...
    return await _uniffi_rust_call_async(
        _UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_resolve_revocation_registry_status_list_full(
        _UniffiConverterTypeLedgerClient.lower(client),
        _UniffiConverterString.lower(rev_reg_def_id),
        _UniffiConverterUInt64.lower(timestamp)),
        _UniffiLib.ffi_indy_besu_vdr_uniffi_rust_future_poll_rust_buffer,
        ...
        _UniffiLib.ffi_indy_besu_vdr_uniffi_rust_future_free_rust_buffer,
        # lift function
        _UniffiConverterTypeRevocationStatusList.lift,
...
def revocation_registry_definition_from_string(rev_reg_def_str: "str") -> "RevocationRegistryDefinition":
    _UniffiConverterString.check_lower(rev_reg_def_str)
    
    return _UniffiConverterTypeRevocationRegistryDefinition.lift(_uniffi_rust_call_with_error(_UniffiConverterTypeVdrError,_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_revocation_registry_definition_from_string,
        _UniffiConverterString.lower(rev_reg_def_str)))


def revocation_registry_definition_get_id(rev_reg_def: "RevocationRegistryDefinition") -> "str":
    _UniffiConverterTypeRevocationRegistryDefinition.check_lower(rev_reg_def)
    
    return _UniffiConverterString.lift(_uniffi_rust_call(_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_revocation_registry_definition_get_id,
        _UniffiConverterTypeRevocationRegistryDefinition.lower(rev_reg_def)))


def revocation_registry_definition_to_string(rev_reg_def: "RevocationRegistryDefinition") -> "str":
    _UniffiConverterTypeRevocationRegistryDefinition.check_lower(rev_reg_def)
    
    return _UniffiConverterString.lift(_uniffi_rust_call_with_error(_UniffiConverterTypeVdrError,_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_revocation_registry_definition_to_string,
        _UniffiConverterTypeRevocationRegistryDefinition.lower(rev_reg_def)))


def revocation_registry_entry_from_string(rev_reg_entry_str: "str") -> "RevocationRegistryEntry":
    _UniffiConverterString.check_lower(rev_reg_entry_str)
    
    return _UniffiConverterTypeRevocationRegistryEntry.lift(_uniffi_rust_call_with_error(_UniffiConverterTypeVdrError,_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_revocation_registry_entry_from_string,
        _UniffiConverterString.lower(rev_reg_entry_str)))


def revocation_registry_entry_to_string(rev_reg_entry: "RevocationRegistryEntry") -> "str":
    _UniffiConverterTypeRevocationRegistryEntry.check_lower(rev_reg_entry)
    
    return _UniffiConverterString.lift(_uniffi_rust_call_with_error(_UniffiConverterTypeVdrError,_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_revocation_registry_entry_to_string,
        _UniffiConverterTypeRevocationRegistryEntry.lower(rev_reg_entry)))


def revocation_status_list_from_string(status_list_str: "str") -> "RevocationStatusList":
    _UniffiConverterString.check_lower(status_list_str)
    
    return _UniffiConverterTypeRevocationStatusList.lift(_uniffi_rust_call_with_error(_UniffiConverterTypeVdrError,_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_revocation_status_list_from_string,
        _UniffiConverterString.lower(status_list_str)))


def revocation_status_list_to_string(status_list: "RevocationStatusList") -> "str":
    _UniffiConverterTypeRevocationStatusList.check_lower(status_list)
    
    return _UniffiConverterString.lift(_uniffi_rust_call_with_error(_UniffiConverterTypeVdrError,_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_revocation_status_list_to_string,
        _UniffiConverterTypeRevocationStatusList.lower(status_list)))


def schema_from_string(string: "str") -> "Schema":
    _UniffiConverterString.check_lower(string)
    
    return _UniffiConverterTypeSchema.lift(_uniffi_rust_call_with_error(_UniffiConverterTypeVdrError,_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_schema_from_string,
        _UniffiConverterString.lower(string)))
...
def schema_get_id(schema: "Schema") -> "str":
    ...
    return _UniffiConverterString.lift(_uniffi_rust_call(_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_schema_get_id,
        _UniffiConverterTypeSchema.lower(schema)))
...
def schema_to_string(data: "Schema") -> "str":
    ...
    return _UniffiConverterString.lift(_uniffi_rust_call_with_error(_UniffiConverterTypeVdrError,_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_schema_to_string,
...
def transaction_create(type: "TransactionType",to: "str",_from: "typing.Optional[str]",nonce: "typing.Optional[int]",chain_id: "int",data: "bytes",signature: "typing.Optional[SignatureData]",hash: "typing.Optional[bytes]") -> "Transaction":
    ...
    return _UniffiConverterTypeTransaction.lift(_uniffi_rust_call(_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_transaction_create,
...
def transaction_endorsing_data_create(to: "str",_from: "str",contract: "str",method: "str",endorsing_method: "str",params: "typing.List[JsonValue]",nonce: "typing.Optional[int]",signature: "typing.Optional[SignatureData]") -> "TransactionEndorsingData":
    ...
    return _UniffiConverterTypeTransactionEndorsingData.lift(_uniffi_rust_call(_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_transaction_endorsing_data_create,
        _UniffiConverterString.lower(to),
        _UniffiConverterString.lower(_from),
...
def transaction_endorsing_data_from_string(value: "str") -> "TransactionEndorsingData":
    ...
    return _UniffiConverterTypeTransactionEndorsingData.lift(_uniffi_rust_call_with_error(_UniffiConverterTypeVdrError,_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_transaction_endorsing_data_from_string,
...
def transaction_endorsing_data_get_signing_bytes(data: "TransactionEndorsingData") -> "bytes":
    ...
    return _UniffiConverterBytes.lift(_uniffi_rust_call_with_error(_UniffiConverterTypeVdrError,_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_transaction_endorsing_data_get_signing_bytes,
...
def transaction_endorsing_data_to_string(data: "TransactionEndorsingData") -> "str":
    ...
    return _UniffiConverterString.lift(_uniffi_rust_call_with_error(_UniffiConverterTypeVdrError,_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_transaction_endorsing_data_to_string,
        _UniffiConverterTypeTransactionEndorsingData.lower(data)))
...
def transaction_from_string(value: "str") -> "Transaction":
    ...
    return _UniffiConverterTypeTransaction.lift(_uniffi_rust_call_with_error(_UniffiConverterTypeVdrError,_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_transaction_from_string,
        _UniffiConverterString.lower(value)))
...
def transaction_get_signing_bytes(data: "Transaction") -> "bytes":
    ...
    return _UniffiConverterBytes.lift(_uniffi_rust_call_with_error(_UniffiConverterTypeVdrError,_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_transaction_get_signing_bytes,
...
def transaction_to_string(data: "Transaction") -> "str":
    ...
    return _UniffiConverterString.lift(_uniffi_rust_call_with_error(_UniffiConverterTypeVdrError,_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_transaction_to_string,
        _UniffiConverterTypeTransaction.lower(data)))
...
__all__ = [
    ...
    "build_create_revocation_registry_definition_endorsing_data",
    "build_create_revocation_registry_definition_transaction",
    "build_create_revocation_registry_entry_endorsing_data",
    "build_create_revocation_registry_entry_transaction",
    ...
    "build_resolve_revocation_registry_definition_transaction",
    ...
    "parse_revocation_registry_definition",
    "resolve_credential_definition",
    "resolve_did",
    "resolve_revocation_registry_definition",
    "resolve_revocation_registry_status_list",
    "resolve_revocation_registry_status_list_full",
    "resolve_schema",
    "revocation_registry_definition_from_string",
    "revocation_registry_definition_get_id",
    "revocation_registry_definition_to_string",
    "revocation_registry_entry_from_string",
    "revocation_registry_entry_to_string",
    "revocation_status_list_from_string",
    "revocation_status_list_to_string",
    "schema_from_string",
    "schema_get_id",
    "schema_to_string",
    "transaction_create",
